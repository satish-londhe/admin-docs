...
**Prev:** [Phase 7 — Compute](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722238) · **Next:** [Day-2 and lifecycle](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623879)
...
Every binding is keyed by **Service ID** for teardown in [Offboarding](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396263426).
...
See [CloudStack reference patterns — state-visible list views](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525575#2-state-visible-list-views).
...
[Day-2 workflow 9.8 — Drift reconciliation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623879) covers the same capability in lifecycle terms. Phase 8 defines the **ongoing operational model**; Day-2 covers triggers (plan changes, manual ops, failed partial offboards).

See [Integrations matrix — orchestration](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525604#orchestration-capabilities).
