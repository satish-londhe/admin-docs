...
**Prev:** [Registration and billing](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396656647) · **Next:** [Phase 1 — IPAM reservation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787713)
...
| Security package | Basic / Standard / Advanced / Enterprise / Enterprise Plus | [VSYS profile](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195#24-palo-alto--admin-configuration-wizard) from admin setup |
| VM specs, storage, network size | Standard CMP compute order fields | [Phase 7 — Compute](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722238) |
| Load balancing / WAF add-on | Optional | [Phase 6 — F5](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396853249) |
| VPN add-on | IPSec / SSL VPN | Panorama VPN config in [Phase 4](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755039) |
...
Phase 0 is the **last customer-visible step**. [Registration and billing](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396656647) covers account creation, KYC, payment, and subscription trigger. After payment approval, CMP starts [Phase 1 — IPAM reservation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787713) without customer interaction.
