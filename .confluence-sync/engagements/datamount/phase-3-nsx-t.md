...
**Prev:** [Phase 2 — VCD](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623926) · **Next:** [Phase 4 — Panorama](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755039)

---

## DataMount ideal

Create customer T0 VRF, T1, segments, NAT, and BGP toward Palo Alto using allocations from [Phase 1](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787713). Tag every object with **Service ID**.
...
> [!NOTE]
> **BGP is mandatory infrastructure**
>
...
- **T0 VRF BGP neighbors** under Networking → Tier-0 Gateways → VRF:
  ...
  - Neighbor status must reach **Established** before [Phase 5 BGP gate](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396558343) can pass
...
![CloudStack Virtual Routers list — template for NSX-T T1 inventory](../../static/img/screenshots/datamount/cloudstack-virtual-routers-list.png)

See [CloudStack reference patterns](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525575#virtual-router--per-tenant-t1-analog).
...
On success → [Phase 4 — Panorama](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755039).
