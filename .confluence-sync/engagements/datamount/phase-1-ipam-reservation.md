...
On order confirmation, CMP performs **one atomic transaction**. VCD, NSX-T, and Palo Alto never independently allocate customer-facing IP/ASN resources — they only consume what CMP hands them. See [Confirmed architecture — ownership](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396394503#provisioning-ownership).

**Prev:** [Phase 0 — Customer order](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396132360) · **Next:** [Phase 2 — VCD](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623926)
...
| Private subnet | Per-VRF allocation; [VRF-scoped overlap](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195#23-vrf-aware-overlap-validation) | **Custom** |
...
| IPAM allocate fail after charge | Refund / credit path (see [Day-2 — provisioning failure](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623879)); release reservation |

On success → [Phase 2 — VCD](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623926).
