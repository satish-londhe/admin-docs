...
| **BGP gate** | BGP validation gate | Hard stop before [Phase 7 compute](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722238) until peers/routes are healthy |
...
| **Resource bindings** | Cross-system mapping | CMP resource ID ↔ VCD / NSX-T / Panorama objects — [Phase 8](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742) |
