...
**Hub:** [DataMount Integration Review](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722177) · **Prev:** [Offboarding](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396263426)
...
Workflow reference: [Confirmed architecture](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396394503) · [Admin setup](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195) · [Customer phases](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396132360) · [CloudStack UX patterns](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525575)
...
|---|---|---|---|
| **M0** | Technical finalisation & environment readiness | Week 1 | [Architecture](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396394503), [Discovery questions](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396361742) |
| **M1** | CMP core / orchestration foundation | Weeks 1–3 | [Integrations matrix](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525604) |
| **M2** | IPAM & ASN management | Weeks 1–3 | [Admin §2.2](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195), [Phase 1](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787713) |
| **M3** | VMware Cloud Director | Weeks 1–6 | [Phase 2](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623926), [Phase 7](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722238) |
| **M4** | NSX-T integration | Weeks 1–7 | [Phase 3](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755006), [Admin §2.5](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195) |
| **M5** | Palo Alto / Panorama | Weeks 1–7 | [Phase 4](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755039), [Admin §2.4](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195) |
| **M6** | Rate cards & service packages | Weeks 4–7 | [Admin §2.6](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195), [Phase 0](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396132360) |
| **M7** | Registration & KYC | Weeks 1–4 | [Registration and billing](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396656647) |
| **M8** | Customer purchase & provisioning | Weeks 6–9 | Phases [0](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396132360)–[7](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722238) |
| **M9** | VM lifecycle & Day-2 operations | Weeks 3–9 | [Day-2 and lifecycle](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623879) |
| **M10** | F5 + Backup / DR * | Weeks 4–9 | [Phase 6 — F5](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396853249) |
| **M11** | Offboarding & reconciliation | Weeks 9–10 | [Offboarding](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396263426), [Phase 8](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742) |
...
| M0.2 | Finalise customer provisioning workflow ([phases 0–7](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396132360)) |
...
| M0.7 | Confirm IPAM allocation model ([Admin §2.2](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195)) |
| M0.8 | Confirm ASN allocation model |
| M0.9 | Confirm [F5 architecture](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396394503#f5--open-architecture-questions) |
...
| Reconciliation | CMP vs infrastructure state ([Phase 8](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742)) |
...
**Weeks 1–3** — Internal IPAM foundation ([CloudStack reference patterns](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525575)).
...
| IP utilization · [VRF-scoped overlap validation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195#23-vrf-aware-overlap-validation) |
...
**Atomic reservation** ([Phase 1](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787713)):
...
Maps to [Phase 2 — VCD](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623926).
...
Maps to [Phase 3 — NSX-T](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755006) and [Phase 5 — BGP gate](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396558343).
...
Maps to [Phase 4 — Panorama](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755039) and [Admin §2.4](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195).
...
Maps to [Admin §2.6](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195) and [Phase 0 — Customer order](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396132360).
...
Maps to [Registration and billing](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396656647).
...
Maps to [Phase 7 — Compute](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722238) and [Day-2 and lifecycle](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623879).
...
Maps to [Phase 6 — F5](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396853249). Backup posture: [Integrations matrix — Veeam](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525604).
...
Maps to [Offboarding](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396263426) and [Phase 8 — Reconciliation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742).
...
|---|---|
| M2 | [Phase 1 — IPAM reservation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787713) |
| M3 (framework) | [Phase 2 — VCD](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396623926) |
| M4 | [Phase 3 — NSX-T](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755006) |
| M5 | [Phase 4 — Panorama](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755039) |
| M8 (BGP) | [Phase 5 — BGP gate](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396558343) |
| M10 (F5) | [Phase 6 — F5](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396853249) |
| M8 / M9 (VM) | [Phase 7 — Compute and handoff](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396722238) |
| M11 | [Phase 8 — Reconciliation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742) |
| M6 / M7 / M8 (portal) | [Phase 0](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396132360), [Registration](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396656647) |

---

## Related

- [Discovery questions](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396361742) — workshop agenda before locking SoW
- [Integrations matrix](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396525604) — CMP posture per capability
- [Open items](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396394503#open-items-before-final-sign-off) — blockers affecting timeline confidence
