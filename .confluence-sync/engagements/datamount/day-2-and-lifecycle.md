...
**Prev:** [Phase 8 — Reconciliation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742) · **Next:** [Offboarding](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396263426)
...
| 9.5 | Day-2 add-on purchase | **Custom** | Re-enter [Phase 6 — F5](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396853249) or Phase 4 VPN blocks |
...
| 9.8 | Drift reconciliation | **Custom** | [Phase 8 — Reconciliation](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742) |
...
|---|---|---|
| Drift | Scheduled reconcile by Service ID tag; alert or auto-heal | **Custom** — see [Phase 8](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787742) |
