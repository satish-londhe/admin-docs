...
**Architecture:** **Physical firewall**, managed via Panorama — **no** VM-Series; **no** NSX-T service insertion. See [Confirmed architecture](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396394503).

**Prev:** [Phase 3 — NSX-T](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396755006) · **Next:** [Phase 5 — BGP gate](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396558343)
...
|---|---|---|---|---|
| 4.1 | Panorama | Create/assign customer VSYS | From selected [VSYS profile](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396296195#24-palo-alto--admin-configuration-wizard) | **Custom** |
...
- Ops today may still use Edge VLAN / ASN spreadsheets during walkthroughs — [Phase 1 IPAM](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396787713) replaces this as system of record.
...
On success → [Phase 5 — BGP gate](https://stackconsole.atlassian.net/wiki/spaces/DataMount/pages/396558343).
