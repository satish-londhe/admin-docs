# CloudStack — Access & Integration Requirements Template
...
**Complete first:** [CMP Platform Requirements template](/requirement-templates/cmp-platform-requirements-template.md) (VMs, domain, SSL — fill **once**, not here).
