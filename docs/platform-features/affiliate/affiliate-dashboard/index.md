...
After an admin approves their account, affiliates log in to the **affiliate portal** at `<BASE_URL>/affiliate/login`.

:::info[Approval required]

Affiliates cannot access the dashboard until an admin approves the registration and sets status **ACTIVE**. See [Manage Affiliates (Admin)](/platform-features/affiliate/admin/manage-affiliates#approve-a-pending-affiliate).
...
The top bar shows **Total Earnings**, theme toggle, notifications, and the logged-in affiliate profile.
...
Full workflow: [Affiliate Workflow](/platform-features/affiliate/admin/workflow#post-approval-steps-810).
