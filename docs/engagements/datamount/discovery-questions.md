...
tags: ["engagement", "datamount", "discovery", "sow"]
---
...
Walk the journey: signup → first API → Organization → Org VDC → quotas → networking → VM → public IP → usage → deletion. Align with [Registration and billing](/engagements/datamount/registration-and-billing) through [Offboarding](/engagements/datamount/offboarding).
