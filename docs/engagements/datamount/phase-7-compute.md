...
tags: ["engagement", "datamount", "vcd", "compute", "handoff"]
---
...
**Only after [Phase 5 — BGP gate](/engagements/datamount/phase-5-bgp-gate) passes.** Optional [Phase 6 — F5](/engagements/datamount/phase-6-f5) may complete before or in parallel with initial VM deploy depending on whether pool members require running VMs.

<div class="no-print">

**Prev:** [Phase 6 — F5](/engagements/datamount/phase-6-f5) · **Next:** [Phase 8 — Reconciliation](/engagements/datamount/phase-8-reconciliation)
...
| 7.2 | VCD | Attach VDC network | Network from [Phase 2](/engagements/datamount/phase-2-vcd) | **Custom** |
...
On success → service **Active**; ongoing [Phase 8 — Reconciliation](/engagements/datamount/phase-8-reconciliation) and [Day-2](/engagements/datamount/day-2-and-lifecycle).
